...
const make_album = (artist, album, tracks) => {
    ...
    if (tracks) albumDetail['Totaltracks'] = tracks;
    return albumDetail;
};

console.log(make_album('Atif Aslam', 'Album1', 5));
console.log(make_album('Alan Walker', 'Album2'));
console.log(make_album('Marooon 5', 'Album3', 6));
